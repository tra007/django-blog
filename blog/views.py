...
def post_detail(request, year, month, day, slug):
    ...
    context = {"post": post, "comments": comments, "new_comments": new_comment, "comment_form": comment_form,
...
def post_search(request):
    ...
    if 'query' in request.GET:
        ...
        if form.is_valid():
            ...
            result = Post.published.annotate(search=search_vector, rank=SearchRank(search_vector, search_query)).filter(
